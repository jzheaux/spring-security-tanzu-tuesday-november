...
/**
 * Note this is part of the demo just for educational purposes. It configures
 * the Authorization Server to accept the implicit grant type. This grant type is
 * no longer considered secure, though, so DO NOT USE.
 */
@Configuration
